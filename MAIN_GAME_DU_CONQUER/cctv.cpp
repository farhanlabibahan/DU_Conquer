...
string game_rules_cctv = "Lights On Game Rules:\nTurn on all the lights to win.\nPress X to exit the game.";
...
void init_cctv() {
    ...
    scale = (float)GetMonitorHeight(0) / bg_image_cctv.height;
    float y_pos_floor = (float)GetMonitorHeight(0) - scale * 350;
   // playerPos_cctv = (Vector2){-10, y_pos_floor};
    playerPos_cctv = {2200*scale,GetMonitorHeight(0)-400*scale};
    exit_zone_cctv = {2200*scale,GetMonitorHeight(0)-400*scale};
    game_zone_cctv = {1950*scale,GetMonitorHeight(0)-400*scale};
...
void logic_draw_cctv() {
    ...
    if (!cctv_game) pop_up_cctv = "Find and Solve the Clue";
