...
void logic_draw_menu()
{
    ...
    // Mouse Clicks
    if (btnNew.IsHovered() && !wasHoveredNew)
        PlayHoverSound();
    ...
    if (btnHigh.IsHovered() && !wasHoveredHigh)
        PlayHoverSound();
    ...
    if (btnHelp.IsHovered() && !wasHoveredHelp)
        PlayHoverSound();
    ...
    if (btnMap.IsHovered() && !wasHoveredMap)
        PlayHoverSound();
    ...
    if (btnSaved.IsHovered() && !wasHoveredSaved)
        PlayHoverSound();
    ...
    if (btnExit.IsHovered() && !wasHoveredExit)
        PlayHoverSound();
