...
string game_rules_cse = "Lights On Game Rules:\nTurn on all the lights to win.\nPress X to exit the game.";
...
void init_cse() {
    ...
    scale = (float)GetMonitorHeight(0) / bg_image_cse.height;
    playerPos_cse = {4700*scale,screenHeight-400*scale};
    exit_zone_cse = {4700*scale,screenHeight-400*scale};
    game_zone_cse = {2500*scale,screenHeight-400*scale};
...
void logic_draw_cse() {
    ...
    if (!cse_game) pop_up_cse = "Find and Solve the Clue";
