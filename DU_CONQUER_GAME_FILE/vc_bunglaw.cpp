...
string game_rules_vc_bunglaw = "Shoot to save!";
...
void init_vc_bunglaw() {
    ...
    scale = (float)GetScreenHeight() / bg_image_vc_bunglaw.height;
    playerPos_vc_bunglaw = {0*scale,screenHeight-400*scale};
    exit_zone_vc_bunglaw = {0*scale,screenHeight-400*scale};
    game_zone_vc_bunglaw = {2600*scale,screenHeight-600*scale};
...
void logic_draw_vc_bunglaw() {
    ...
    if (!shooting_game) pop_up_vc_bunglaw = "Holes in the wall";
