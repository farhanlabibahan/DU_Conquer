...
string game_rules_eee_first = "Stay alert for the right signal";
...
void init_eee_first() {
    ...
    scale = (float)GetScreenHeight() / bg_image_eee_first.height;
...
void logic_draw_eee_first() {
    ...
    if (!eee_game_1) pop_up_eee_first = "High Voltage detected \n How to measure!";
