...
string game_rules_nuclear = "Watch the numbers,,not the clues";
...
void init_nuclear() {
    ...
    scale = (float)GetScreenHeight() / bg_image_nuclear.height;
...
void logic_draw_nuclear() {
    ...
    if (!nuclear_game) pop_up_nuclear = "You can't bruteforce a NUKE,Think not GUESS";
