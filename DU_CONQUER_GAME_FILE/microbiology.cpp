...
string game_rules_microbiology = "Feed the worm to clean up the pretri-dish";
...
void logic_draw_microbiology() {
    ...
    if (!microbiology_game) pop_up_microbiology = "Keep looking for microbiological things";
    ...
    if (dept_status_microbiology == Dept_microbiology) {
        ...
        if (CheckCollisionCircles(playerPos_microbiology, 50.0f, exit_zone_microbiology, 50.0f)) {
            pop_up_microbiology = "Press E to Elevator";
