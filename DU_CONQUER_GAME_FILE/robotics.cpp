...
string pop_up_robotics = "Who cleaned up the floor? It's all neat!";
string game_pop_up_robotics= " ";
string game_rules_robotics = "choose the  components in the correct order\n Use your intuition..and maybe a bit of math? ";
...
void init_robotics() {
  ...
  //  PlayMusicStream(bgm_robotics);
    ...
    scale = (float)GetScreenHeight() / bg_image_robotics.height;
